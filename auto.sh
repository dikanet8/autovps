...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 443 -p 1997 -p 22507 -p 2000 -p 2017"/g' /etc/default/dropbear
echo "/bin/false" >> /etc/shells
service ssh restart
...
# Install Menu
cd
wget "https://raw.githubusercontent.com/AidikaAA/autovps/master/b"
mv ./b /usr/local/bin/menu
